...
;(function() {
	...
	var options = {
		'maxPageWidth' :     '1170px',                       // set overlay width to match page width (as max-width for flexible grids)
		'columnWidth' :      '70px',                        // set column width in px
		'columnCount' :       12,                           // set column count
		'columnColor' :      'rgba(255, 0, 0, 0.15)',       // set column color
		'gutterWidth' :      '30px',                        // set gutter width in px
		'baselineHeight' :    24,                           // set baseline height in px
		'baselineColor' :    'rgba(255, 255, 255, 0.5)',    // set baseline color
		'initialDisplay' :   'none'                        // 'block' will show grid on load; 'none' will hide on load
	},
	...
	columnPercentage = ( columnWidthInt / maxPageWidthInt ) * 100 + '%', //6.87831%
	gutterPercentage = ( gutterWidthInt / maxPageWidthInt ) * 100 + '%', //1.5873%
	...
	// console.log(maxPageWidthInt);
	// console.log(columnWidthInt);
	// console.log(gutterWidthInt);
	// console.log(columnPercentage);
	// console.log(gutterPercentage);
	...
	for (var i = 0; i < options.columnCount; i++) {
		...
		column.style.cssText = '\
			...
			width: 5.982905982905983%;';// + columnPercentage + ';';
	};
